const CACHE='race-checkin-v1';
const SHELL=['/checkin.webmanifest','/companion-icon.svg'];
const OFFLINE_PAGE='<!doctype html><meta name="viewport" content="width=device-width"><meta name="theme-color" content="#112033"><style>html,body{margin:0;min-height:100%;background:#f3f6f9;color:#172130;font:18px system-ui}main{box-sizing:border-box;min-height:100vh;display:grid;place-content:center;padding:28px;text-align:center}section{max-width:430px;padding:24px;background:white;border:1px solid #d99a38;border-radius:14px}p{color:#657284;line-height:1.5}button{padding:14px 22px;border:0;border-radius:8px;background:#0879e8;color:white;font:700 1rem system-ui}</style><main><section><h1>Check-in roster is offline</h1><p>Reopen the saved Check-In app. If this screen remains, reconnect to the Race Assistant laptop and try again.</p><button onclick="location.reload()">Retry</button></section></main>';
